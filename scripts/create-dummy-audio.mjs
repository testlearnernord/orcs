...
const createMinimalMP3 = () => {
  ...
  const mp3Header = Buffer.from([
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Padding and frame data
...
try {
  ...
  await writeFile(`${audioDir}/curse-of-the-witches-jimena-contreras.mp3`, mp3Data);
  ...
  console.log('');
  console.log('Note: These are minimal placeholder files to prevent 404 errors.');
  console.log('Replace with actual audio files as described in AUDIO_CREDITS.md');
} catch (error) {
