...
describe('AudioManager', () => {
  describe('basic functionality', () => {
    ...
    it('should have valid audio URLs with proper base paths', () => {
      ...
      expect(state.tracks[0].url).not.toBe('/audio/Curse of the Witches - Jimena Contreras.mp3');
      expect(state.tracks[1].url).not.toBe('/audio/Whirlpool - The Mini Vandals.mp3');
      
      // URLs should contain the audio filename
      expect(state.tracks[0].url).toContain('Curse of the Witches - Jimena Contreras.mp3');
