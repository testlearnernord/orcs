import { ATLAS_SPECS, type AtlasDefinition, type AtlasSpec } from './config';
...
export async function sliceTileToURL(
  ...
  ctx.drawImage(source, sourceSx, sourceSy, sourceSw, sourceSh, 0, 0, size, size);
...
export function getLastPortraitStatus(): PortraitLoadStatus | null {
  return lastStatus ? { ...lastStatus, tried: [...lastStatus.tried], ok: [...lastStatus.ok], fail: [...lastStatus.fail] } : null;
  allAtlasesPromise = null;
}
